...
export default function AstrologicalSign (props) {

    const [astrologicalSigns,setAstrologicalSign] = useState([])
    ...
    return(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4">
            ...
            <div className="my-3">
                ...
                {astrologicalSigns.map((astrologicalSign)=>{
                    if(astrologicalSign.name.toLowerCase().search(search.toLowerCase()) === -1 ){
                        return null
                    }
                    return(

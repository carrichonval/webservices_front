...
export default function MusicTypes (props) {
    ...
    const fetchMusicTypes = ()=> {
        fetch(process.env.REACT_APP_API_URL+"/musicTypes",{
            method:'GET',
            headers:{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4">
            ...
            <div className="my-3">
                ...
                {musicTypes.map((musicType)=>{
                    if(musicType.name.toLowerCase().search(search.toLowerCase()) === -1 ){
                        return null
                    }
                    return(
